...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS com.jd.thriftzookeeper.main.server.TestServerCluster 192.168.228.46:12181 > $STDOUT_FILE 2>&1 &
